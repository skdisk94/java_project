...
<body>
	...
	<div id="carousel-example-generic" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="../img/bcyMain1.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="../img/bcyMain2.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="../img/bcyMain3.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="../img/bcyMain4.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="../img/bcyMain5.jpg">
				<div class="carousel-caption"></div>
			</div>
	...
	<div class="container">
		<div class="row" style="margin-top: 70px">
			...
			<c:set var="bicycleImgTop" value="${requestScope.bicycleImgTop}" />
			<c:forEach var="pDto" items="${bicycleImgTop}">
				<div class="col-md-2">
					<div class="thumbnail">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12"></div>
					<div class="col-md-1"></div>
					<c:set var="bicycleImgBottom"
						value="${requestScope.bicycleImgBottom}" />
					<c:forEach var="pDto" items="${bicycleImgBottom}">
						<div class="col-md-2">
							<div class="thumbnail">
								<a data-target="#modal${pDto.pId}" data-toggle="modal"><img
									src="${pDto.pImgName}" alt="${pDto.pName}"></a>
								...
								<table align="center">
									<tr>
										...
										<td rowspan="2" align="center"><font size="4pt">${pDto.pName}</font><br>
											...
											<input type="submit" value="장바구니 담기" onClick="addList()"></td>
									<tr>
									</tr>
									<tr>
									<tr>
	...
	<c:set var="bicycleImgBottom" value="${requestScope.bicycleImgBottom}" />
	<c:forEach var="pDto" items="${bicycleImgBottom}">
		<div class="row">
			<div class="modal fade" id="modal${pDto.pId}" tabindex="-1">
				<div class="modal-dialog">
