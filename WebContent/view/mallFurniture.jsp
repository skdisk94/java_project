...
<body>
	...
	<div id="carousel-example-generic" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="../img/fntMain1.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="../img/fntMain2.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="../img/fntMain3.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="../img/fntMain4.jpg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img src="../img/fntMain5.jpg">
				<div class="carousel-caption"></div>
			</div>
	...
	<div class="container">
		<div class="row" style="margin-top: 70px">
			...
			<c:set var="furnitureImgTop" value="${requestScope.furnitureImgTop}" />
			<c:forEach var="pDto" items="${furnitureImgTop}">
				<div class="col-md-2">
					<div class="thumbnail">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12"></div>
					<div class="col-md-1"></div>
					<c:set var="furnitureImgBottom"
						value="${requestScope.furnitureImgBottom}" />
					<c:forEach var="pDto" items="${furnitureImgBottom}">
						<div class="col-md-2">
							<div class="thumbnail">
								<a data-target="#modal${pDto.pId}" data-toggle="modal"><img
									src="${pDto.pImgName}" alt="${pDto.pName}"></a>
