					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu" role="menu">
								<li><a
									href="../control/admin_control.jsp?action=viewDaily&page=1">일단위 고객 매출액</a></li>
	...
	<div class="row" style="margin-top: 90px">
		...
		<div class="col-md-10">
			<div class="panel panel-primary" align="center">
				<div class="panel-heading">일단위 고객 매출액</div>
					...
					<table class="table">
						...
						<c:forEach var="odDto" items="${orderByDaily}">
							...
							<c:forEach var="dDto" items="${detailList}"  varStatus="status">
								<c:choose>
									<c:when test="${odDto.oDate.equals(dDto.date)&&!dDto.date.equals(detailList[status.index-1].date)}">
									<tr>
									<td align="center">${odDto.oDate}</td>
									<td align="center">${dDto.customerId }</td>
									...
									<c:when test="${odDto.oDate.equals(dDto.date)}">
									<tr>
									<td align="center" style="border-top : hidden"></td>
									<td align="center" style="border-top : hidden">${dDto.customerId }</td>
							...
							<td colspan="8" align="center">
								<nav>
									<ul class="pagination">
										...
										<c:set var="pageArrayByDaily" value="${requestScope.pageArrayByDaily}" />
										<c:forEach var="pageNum" items="${pageArrayByDaily}">
											<c:choose>
												...
												<c:otherwise>
													<li><a
														href="../control/admin_control.jsp?action=viewDaily&page=${pageNum}">${pageNum}</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
