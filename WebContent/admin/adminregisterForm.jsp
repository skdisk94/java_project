...
.btn-register:hover, .btn-register:focus {
	...
	border-color: #394035;
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<a href="../admin/admin.jsp"><img src="../img/EzenLogo2.png"
						width="160" height="60"></a> </a>
				</div>
				<div class="col-md-4">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-expanded="false">
								매출액 확인&nbsp;<i class="glyphicon glyphicon-qrcode"></i>&nbsp;&nbsp;<span
								class="caret"></span>
						</a>
						...
						<li><a href="../control/admin_control.jsp?action=showUserList">사용자 목록&nbsp;<i
			...
			<div class="col-md-10">
				<div class="jumbotron">
					...
					<h5>
						...
						through the checkout process faster, <br>store multiple
